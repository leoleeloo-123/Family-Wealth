...
export const INITIAL_APP_DATA: any = {
  ...
  账户: [
    { 账户ID: 'ACC001', 账户昵称: 'Main Checking', 成员ID: 'M001', 成员昵称: 'Alpha (Head)', 机构ID: 'INST001', 机构名称: 'Global Bank Corp', 币种: 'USD', 账户类型: 'Checking', 资产类型: 'Cash', 风险评估: 'Low', 收益等级: 'None', 账号: '****1234', 密码: 'demo123', 设备ID: 'DEV001', 设备昵称: 'Main iPhone', 账户细节: 'Primary spending account', 登录备注: '2FA enabled' },
    { 账户ID: 'ACC002', 账户昵称: 'Retirement 401k', 成员ID: 'M002', 成员昵称: 'Beta (Partner)', 机构ID: 'INST003', 机构名称: 'Vanguard Group', 币种: 'USD', 账户类型: 'Investment', 资产类型: 'Stock', 风险评估: 'Medium', 收益等级: 'Growth', 账号: '****5678', 密码: 'pass999', 设备ID: '', 设备昵称: '', 账户细节: 'Long-term equity focus', 登录备注: '' }
  ],
  保险: [
